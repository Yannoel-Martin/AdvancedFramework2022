...
import campus.academy.rennes.domain.Employee;
import campus.academy.rennes.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link campus.academy.rennes.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional

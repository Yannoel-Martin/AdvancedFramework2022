package campus.academy.rennes.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, campus.academy.rennes.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, campus.academy.rennes.repository.UserRepository.USERS_BY_EMAIL_CACHE);
